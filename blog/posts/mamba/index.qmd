...
![](./feature.gif){.lightbox fig-align="center" height="300"}
...
::: {#fig-state-spectrum}
![](./state_spectrum.png){.lightbox fig-align="center" width="70%"}
...
::: {#fig-signaldata}
![](./signal_data.png){.lightbox fig-align="center" height="220"}
...
::: {#fig-lra}
![](./long_range_arena.png){.lightbox fig-align="center" width="80%"}
...
![](./scaling_laws.png){.lightbox width="80%" fig-align="center"}

![](./efficiency_benchmark.png){.lightbox width="80%" fig-align="center"}
...
![**Head View**: Visualising attention head activations between different layers. Connecting lines are weighted based on the attention score between respective words.](./bertviz_head.gif){.lightbox width="61%"}

![**Neuron View**: Visualising query, key and value embeddings when computing attention between each token and other tokens within the sequence. Positive values are colored as blue and negative values as orange.](./bertviz_neuron.gif){.lightbox width="200%"}
...
![OpenAI's GPT-4-128K Long Context Performance](./gpt4_long_context.png){.lightbox width="100%"}

![Anthropic's Claude 2.1 Long Context Performance](./claude_long_context.png){.lightbox width="100%"}
...
![](./lost_in_the_middle.png){.lightbox width="350" fig-align="center"}

**Lost in the Middle**: Performance Degrades When Information Access is in the Middle of Document [@liu2023lost]
:::
...
::: {#fig-kvcache}
![](./kv_cache.gif){.lightbox width="70%" fig-align="center"}
...
::: {#fig-rnn}
![](./rnn.gif){.lightbox width="60%" fig-align="center"}
...
::: {#fig-lssml}
![](./state_space_layer.png){.lightbox width="70%" fig-align="center"}
...
![](./ssm_cont_simplified.png){.lightbox width="500" fig-align="center"}

![](./ssm_cont.png){.lightbox width="500" fig-align="center"}
...
![Zero Order Hold Sampling Function](./zero_order_hold.png){.lightbox width="500" fig-align="center"}

![Discrete SSM Diagram [@grootendorst2024mamba]](./discrete_ssm.png){.lightbox width="500" fig-align="center"}
...
::: {#fig-s4-conv}
![](./conv_layer.gif){.lightbox width="600" fig-align="center"}
...
![Signal in Time and Frequency Domain [@fftbasicnti]](./fft_signal_decomposition.png){.lightbox width="80%" fig-align="center"}

![Legendre Polynomials [@wiki24legendre]](./legendre.png){.lightbox width="80%" fig-align="center"}
...
![](./ssm.png){.lightbox width="600" fig-align="center"}

![](./hippo.gif){.lightbox width="550" fig-align="center"}

![](./hippo_transform.png){.lightbox width="550" fig-align="center"}
...
![Diagonal Plus Low-rank Approximation](./DPLR.png){.lightbox width="100%" fig-align="center"}

![**S4D Recurrent and Convolutional View**: Colors denote independent 1D SSMs; purple denotes trainable parameters [@gu2022parameterization]](./s4d_arch.png){.lightbox width="100%" fig-align="center"}

S4 vs S4D Architecture
:::

::: {#fig-s4d layout-ncol="2" layout-valign="center"}
![Visualising S4 vs S4D Results](./s4_vs_s4d.png){.lightbox height="350" fig-align="center"}

![S4 vs S4D Long Range Arena Results](./s4d_results.png){.lightbox width="100%" fig-align="center"}
...
::: {#fig-mamba-algo}
![](./selective_ssm_algo.png){.lightbox fig-align="center" width="70%"}
...
![**Selective Copying**: This requires time-varying models that can selectively remember or ignore inputs depending on their content.](./selective_copying.png){.lightbox width="100%" fig-align="center"}

![**Induction Heads**: This is an associative recall task which requires retrieving an answer based on context, a key ability of LLMs.](./induction_heads.png){.lightbox width="100%" fig-align="center"}
...
![**Selective Copying Results**: Accuracy for combinations of architectures](./selective_copying_results.png){.lightbox width="60%" fig-align="center"}

![**Induction Heads Extrapolation**: Mamba has ability to maintain high induction test accuracy for sequence length up to 1 million tokens](./induction_heads_results.png){.lightbox width="100%" fig-align="center"}
...
![**(Left)**: Average Memory Bandwidth for [A100](https://www.nvidia.com/en-us/data-center/a100/) **(Right)**: Selective SSM Architecture Simplified: The select state layer is kept and computed in SRAM. [@grootendorst2024mamba]](./selective_ssm_simple.png){.lightbox fig-align="center" width="600"}

![**State Selection with Hardware-Aware State Expansion**: The selection mechanism ensures the expanded matrix states only materialise in SRAM to reduce data transfer and computation between SRAM\<\>HBM. [@gu2023mamba]](./selective_ssm_hardware.png){.lightbox fig-align="center" width="600"}
...
![Visualisation of Linear Scan](./linear_scan.gif){.lightbox fig-align="center" width="80%"}

![Visualisation of Blelloch Algorithm (Work-Efficient Parallel Prefix Scan)](./blelloch_scan.gif){.lightbox fig-align="center" width="80%"}
...
::: {#fig-flash-attention}
![**(Left)**: FlashAttention: The $\mathbf{(QK)V}$ matrix of size $N^2$ is computed in SRAM using tiling before being written to HBM. **(Right)**: Speedup of Attention on GPT-2](./flash_attention.png){.lightbox fig-align="center" width="50%"}
...
![Neural Network Computation Graph [Source](https://stats.stackexchange.com/questions/377427/storage-and-re-computation-of-intermediate-weight-back-propagated-gradients)](./recomputation_graph.png){.lightbox fig-align="center" width="50%"}

![Recomputing of Activations on Backward Pass: Blue = forward, Red = backward [Source](https://docs.graphcore.ai/projects/memory-performance-optimisation/en/latest/common-mry-optimisations.html#activations-recomputation-and-memory-use)](./recomputation_operation.png){.lightbox fig-align="center" width="50%"}

![Saving GPU Memory with Re-computation [@korthikanti2022reducing]](./recomputation_memory.png){.lightbox fig-align="center" width="50%"}
...
![From H3 to the Mamba Block [@fu2023hungry]](./h3_mamba_arch.png){.lightbox fig-align="center" width="100%"}

![Mamba Block Decoder Architecture [@grootendorst2024mamba]](./mamba_block_arch.png){.lightbox fig-align="center" width="80%"}
...
![Comparison of Mamba variants with different popular 7B LLMs on Piqa, Winogrande, Lambada, and Hellaswag [Source](https://hub.zenoml.com/report/2443/Mamba%20vs%207B?)](./commonsense_benchmark.png){.lightbox fig-align="center" width="100%"}

![Evaluation Comparison of Mamba variants with several similar-sized LLMs [@gu2023mamba]](./commonsense_results.png){.lightbox fig-align="center" width="100%"}
...
![Timeline of SSM based Models [@wang2024state]](./ssm_timeline.png){.lightbox fig-align="center" width="80%"}

![SSM Model Landscape Over Various Domains [@patro2024mamba360]](./ssm_applications.png){.lightbox fig-align="center" width="100%"}
...
![Vision Mamba Scan Techniques](./vmamba_scan_techniques.png){.lightbox fig-align="center" width="100%"}

![Vision Mamba Model Landscape](./mamba_vision.png){.lightbox fig-align="center" width="100%"}
